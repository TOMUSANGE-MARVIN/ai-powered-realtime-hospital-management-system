...
// Helper to map action strings to specific icons and colors
...
export function RecentActivity() {
  const queryKey = ["activities-log", 1]; // We only want the most recent (page 1)

  // 1. Fetch data using your provided snippet
  const { data, isLoading, isError } = useQuery({
    queryKey,
    queryFn: () => getActivityLogs({ page: 1, limit: 5 }), // Show last 5 items
